...
void  HttpRequestPoolRunnable::run() {
    ...
    try {
        ...
        std::cout<<"Requesting to URL: " + url<<std::endl;
        ...
        // fileLogger.error("Error returned by URL: " + url + excp.displayText());
    } catch (std::exception ex) {
        // fileLogger.error("Error returned by URL: " + url + ex.what());
    } catch(const char *err) {
        // fileLogger.error("Error returned by URL: " + url + err);
    }
}

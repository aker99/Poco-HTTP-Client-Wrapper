...
// const HTTPRequestWrapper::CustomHttpResponse HTTPRequestWrapper::get(const URI &uri, const std::string &loggerName)
// {
...
//                 const Poco::URI newUri(finalResponse.header.get("Location"));
//                 if(uri == newUri) {
...
//                         session->reset();
//                         session =  CustomHTTPSessionFactory::createSession(currentURI);
